  ...
  return (
    <div>
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between mt-2">
        <div className="w-full md:w-full lg:w-3/5 xl:w-1/2 2xl:w-1/2 4xl:w-2/5 mt-14">
          <div className="flex flex-col items-start justify-evenly bg-primaryPink rounded-xl p-5 lg:h-[200px] 2xl:h-[220px] 3xl:h-[260px]">
            <div className="bg-secondaryPurple rounded-xl p-2">
              <FaLaptopCode color="white" size={40} />
            </div>
            <div>
              <h3 className="text-white font-bold 3xl:text-xl 4xl:text-3xl mt-10">
                Desenvolvimento Web
              </h3>
              <p className="text-white lg:text-sm 3xl:text-base 4xl:text-xl">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-6">
            <div className="flex flex-col items-start justify-evenly bg-primaryPink rounded-xl mt-6 md:mt-0 p-5 w-full md:w-[48%] lg:h-[200px] xl:h-[220px] lg:w-[48%] 3xl:h-[260px]">
              <div className="bg-secondaryPurple rounded-xl p-2">
                <FaCogs color="white" size={40} />
              </div>
              <div>
                <h3 className="text-white font-bold 3xl:text-xl 4xl:text-3xl mt-4">
                  Gestão de sites
                </h3>
                <p className="text-white lg:text-sm 3xl:text-base 4xl:text-xl">
            ...
            <div className="flex flex-col items-start justify-evenly bg-primaryPink rounded-xl mt-6 md:mt-0 md:mb-0 mb-6 p-5 w-full md:w-[48%] lg:h-[200px] xl:h-[220px] lg:w-[48%] 3xl:h-[260px]">
              <div className="bg-secondaryPurple rounded-xl p-2">
        ...
        <div className="lg:order-first md:w-0 lg:w-3/5 xl:w-2/5 3xl:w-2/6">
          <img
