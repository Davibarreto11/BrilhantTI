...
const Contact: React.FC = () => {
  ...
  const [selectedTypeUI, setSelectedTypeUi] = useState(Boolean);
  const [selectedTypeDesign, setSelectedTypeDesign] = useState(Boolean);
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row lg:justify-between items-center justify-center scroll-smooth">
        ...
        <div>
          <div className="flex items-center ml-3 sm:ml-6 mt-24 3xl:mt-0">
            ...
            <a
              ...
              className="ml-2 text-xl 4xl:text-2xl"
            >
          ...
          >
            <div className="flex items-center mt-7">
              <button className="ml-2 text-xl 3xl:text-xl bg-primaryPink p-4 pr-10 sm:pr-28 xl:pr-36 pl-14 rounded-xl opacity-75">
                (88) 99648-8674
              </button>
              <FaPhoneAlt
        ...
        <div className="h-full flex flex-col items-center lg:items-start md:justify-center lg:justify-around">
          <div>
            ...
            <div className="flex items-center mt-5 mb-24">
              <button
                onClick={() => {
                  setSelectedTypeDesign(!selectedTypeDesign);
                ...
                className={`
                  ...
                  `}
              >
                <p className={`${selectedTypeDesign ? "text-black font-bold" : ""}`}>
                  UX design
                </p>
              </button>
              <button
                onClick={() => {
                  setSelectedTypeUi(!selectedTypeUI);
                  setType("Web design");
                }}
                className={`
                  bg-transparent 
                  ...
                  `}
              >
                <p className={`${!selectedTypeUI ? "text-black font-bold" : ""}`}>
                  Web design
                </p>
              </button>
            </div>
          ...
          <div className="w-full h-full flex flex-col items-start justify-evenly">
            ...
            >
              <input
                ...
                value={name}
                className="w-full outline-none pb-5 bg-primaryPink border-b-2 font-bold placeholder:text-white text-white 2xl:text-lg 3xl:text-xl"
                type="text"
                placeholder="Nome..."
                required
              />
              ...
              <input
                ...
                value={message}
                className="w-full outline-none pb-12 text- bg-primaryPink border-b-2 font-bold placeholder:text-white text-white 2xl:text-lg 3xl:text-xl"
                type="text"
